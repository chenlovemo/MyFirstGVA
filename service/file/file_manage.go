...
var FileManageServiceApp = new(FileManageService)
...
func (exa *FileManageService) CreateFileManage(e file.FileManageStruct) (err error) {
...
func (exa *FileManageService) DeleteFileManage(e file.FileManageStruct) (err error) {
...
func (exa *FileManageService) UpdateFileManage(e *file.FileManageStruct) (err error) {
...
func (exa *FileManageService) GetFileManage(id uint) (category file.FileManageStruct, err error) {
...
func (exa *FileManageService) GetFileManageInfoList(sysUserAuthorityID uint, info request.PageInfo) (list interface{}, total int64, err error) {
	limit := info.PageSize
	offset := info.PageSize * (info.Page - 1)
	//db := global.GVA_DB.Model(&example.ExaCustomer{})
	db_detail := global.GVA_DB.Model(&file.FileManageStruct{})
	db_count := global.GVA_DB.Model(&file.FileManageStruct{})
	...
	//}
	var CategoryList []file.FileManageStruct
